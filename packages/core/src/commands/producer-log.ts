...
export class Command extends Commands.Command {
     ...
     * @memberof Command
     */
    public signature: string[] = ["producer:log", "producer:logs", "log:producer", "logs:producer"];
     ...
     * @memberof Command
     */
    public hide: string[] = ["producer:logs", "logs:producer"];
     ...
     * @memberof Command
     */
    public description: string = "Display the Block Producer process log";
    ...
    public async execute(): Promise<void> {
        ...
        await this.app
            ...
            .execute(this.getFlag("token"), this.getFlag("network"), ["producer"], this.getFlag("lines"));
    }
}
