    ...
    public async migrate(queryRunner: Contracts.Database.QueryRunner): Promise<any> {
        await queryRunner.transaction([
            `CREATE TABLE IF NOT EXISTS transactions (
                ...
                burned_fee_percent INTEGER NOT NULL,
            ...
            "CREATE INDEX IF NOT EXISTS index_transactions_block_height_fee_burned_fee_percent ON transactions(block_height, fee, burned_fee_percent)",
            ...
            "CREATE INDEX IF NOT EXISTS index_transactions_type_id_block_height_sequence_fee_burned_fee_percent ON transactions(type_id, block_height, sequence, fee, burned_fee_percent)",
